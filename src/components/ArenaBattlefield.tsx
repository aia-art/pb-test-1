export default function ArenaBattlefield() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex flex-col items-centre justify-centre py-16 gap-10 animate-fade-in">
      ...
      <div className="w-full max-w-md bg-[#1c2120]/60 border border-[#a1d0c6]/10 rounded-2xl p-7 space-y-4">
        ...
        <ul className="space-y-3">
          {phases.map((p, i) => (
            <li key={i} className="flex items-centre gap-3">
      ...
      <p className="text-xs text-[#c0c8c5]/30 font-mono max-w-sm text-centre">
